...
export const getCinemaSchedulesByMovie = Router().use("/", asyncHandler((req: Request, res: Response) => cinemasController.getMovieById(req, res), "getCinemaSchedulesByMovie"));
